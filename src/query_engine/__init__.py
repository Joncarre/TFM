...
from src.query_engine.diagnostics import QueryDiagnostics

# Modificar la inicialización del motor de consultas:
...
# Modificar el método process_query para registrar diagnósticos:
